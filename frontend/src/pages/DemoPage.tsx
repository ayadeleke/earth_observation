...
const DemoPage: React.FC = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    // If no coordinates provided, use a default global area for demonstration
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p className="lead">Experience satellite imagery analysis with simulated data - no authentication required</p>
            </div>
            <div className="col-lg-4 text-end">
              <div className="mb-3">
                ...
                >
                  <i className="fas fa-user-plus"></i> Get Full Access
                </button>
              </div>
              <i className="fas fa-globe-americas" style={{ fontSize: '4rem', opacity: '0.3' }}></i>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-12 mb-3">
            ...
            >
              ...
              For authentic Google Earth Engine analysis, please <button className="btn btn-link p-0 text-decoration-underline" onClick={() => navigate('/register')}>create an account</button>.
            </motion.div>
          </div>
        </div>
