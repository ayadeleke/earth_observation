...
urlpatterns = [
    ...
    path('get_analysis_capabilities/', views.get_analysis_capabilities, name='analysis_capabilities'),
    
    # Demo endpoint
    path('demo/', views.demo_endpoint, name='demo'),
    
    # Project management
    path('projects/', views.AnalysisProjectListCreateView.as_view(), name='project-list'),
    path('projects/<int:pk>/', views.AnalysisProjectDetailView.as_view(), name='project-detail'),
    
    # Geometry and file management
    path('geometries/', views.GeometryInputListCreateView.as_view(), name='geometry-list'),
    ...
    path('earth-engine/update/', views.update_earth_engine_auth, name='update-earth-engine-auth'),
    path('earth-engine/check/', views.check_earth_engine_auth, name='check-earth-engine-auth'),
]
